...
const PurchaseDetails = ({
  ...
  return (
    <div
      className={` left-[100%] flex flex-col items-end justify-end gap-[0.568rem] w-[100%] text-center text-[0.875rem] text-gray-100 font-assistant ${className}`}
        ...
        <div className="flex-1 flex flex-col items-start justify-start  text-left text-[1.25rem] h-[20%] w-[30%]">
          ...
          {/* <div className="self-stretch rounded-xl bg-white flex flex-row items-start justify-start pt-[0.625rem] px-[0.5rem] pb-[0.875rem] [row-gap:20px] z-[4] mt-[-0.919rem] text-center text-[0.875rem] border-[1px] border-solid border-darkgray mq450:flex-wrap">
            ...
            <div className="h-[9.069rem] w-[5.313rem] flex flex-col items-end justify-start gap-[0.531rem] min-w-[5.313rem] mq450:flex-1">
              <img
                className="w-[2rem] flex-1 relative max-h-full object-cover z-[5]"
                loading="lazy"
                alt=""
                src={image8}
              />
              <div className="self-stretch relative leading-[0.938rem] z-[5]">
                Plain chiffon Maxi dress 6
              </div>
            </div>
        ...
        {/* <div className="h-[13.281rem] flex flex-col items-end justify-start gap-[0.643rem]">
          ...
          <div className="flex-1 rounded-tl-xl rounded-tr-none rounded-br-none rounded-bl-xl bg-white flex flex-col items-end justify-start pt-[0.718rem] pb-[0.975rem] pr-[1.687rem] pl-[0.437rem] gap-[0.531rem] z-[3] border-t-[1px] border-solid border-darkgray border-b-[1px] border-l-[1px]">
            ...
            <div className="w-[5.313rem] relative leading-[0.938rem] flex items-center justify-center z-[4]">
              Plain chiffon Maxi dress 4
            </div>
          </div>
        </div> */}
      {/* </div> */}
      <div className="relative self-stretch rounded-t-none rounded-br-21xl rounded-bl-none bg-white flex flex-row items-end justify-start pt-[0rem] pb-[2.131rem] pr-[0rem] pl-[1.5rem] box-border gap-[1.112rem] max-w-full z-[2] mq825:flex-wrap mq825:pl-[1.25rem] mq825:pt-[1.25rem] mq825:pr-[1.25rem] mq1525:h-[14rem] mq825:box-border h-[12rem] w-[100%] right-[-5%]">
  <div className=" w-[100%] relative rounded-t-none rounded-br-21xl rounded-bl-none bg-white hidden max-w-full" />

  <div className="absolute top-0 left-[-10%] mq1525:left-[-20%] flex-1 flex flex-col items-end justify-end w-[45%] text-left text-[1.25rem]">
    <div className="relative leading-[2rem] z-[3] mq450:text-[1rem] mq450:leading-[4rem] text-xs">
      Recommendations
    </div>
          <div className="self-stretch rounded-xl  bg-white flex flex-row items-start justify-start pt-[0.625rem] px-[0.5rem] pb-[0.875rem] [row-gap:20px] z-[4] mt-[1.5rem] text-center text-[0.875rem] border-[1px] border-solid border-darkgray mq450:flex-wrap  ml-[40%] mq1525:ml-[60%] h-[7.763rem] w-[10.15rem]">
            ...
            <div className="h-[8.063rem] w-[5.313rem] flex flex-col items-end justify-start gap-[0.525rem] min-w-[5.313rem] mq450:flex-1">
              <img
                ...
                src={image15}
              />
              <div className="self-stretch relative leading-[0.738rem] shrink-0 z-[5] text-xs">
                Plain chiffon Maxi dress 3
              </div>
            </div>
              ...
              <div className="self-stretch flex flex-col items-end justify-start gap-[0.756rem]">
                <div className="self-stretch flex flex-row items-start justify-end py-[0rem] pr-[0.125rem] pl-[0rem]">
                  <div className="flex-1 flex flex-row items-start justify-start gap-[0.3rem]">
                    <img
                      className="h-[5.863rem] w-[5rem] relative object-cover z-[6]"
                      loading="lazy"
                      alt=""
                      src={image16}
                    />
                ...
                <div className="flex flex-row items-start justify-start gap-[1.056rem]">
                  <div className="relative [text-decoration:line-through] leading-[1.25rem] inline-block text-xs z-[5] ml-[]">
                    4002
                  </div>
                  <div className="relative leading-[1.25rem] text-black inline-block [text-shadow:1px_0_0_#000,_0_1px_0_#000,_-1px_0_0_#000,_0_-1px_0_#000] min-w-[3.063rem] z-[5] mq450:text-[1.25rem] mq450:leading-[1rem] text-xs">
                    1500
                  </div>
                </div>
              </div>
